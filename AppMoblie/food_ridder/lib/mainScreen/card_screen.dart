                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Row(
                                children: <Widget>[
                                  Container(
                                    child: Text("Physical Card", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Colors.grey[900]),),
                                  ...
                                  Container(
                                    child: Text("Virtual Card", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Colors.grey[900]),),
                                    decoration: const BoxDecoration(
                                        color: Colors.white,
                                        borderRadius: BorderRadius.all(Radius.circular(20)),
                                        boxShadow: [BoxShadow(color: Color.fromRGBO(243, 245, 248, 1), blurRadius: 10.0, spreadRadius: 4.5)]
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text("**** **** **** 9647", style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                                    ...
                                    children: <Widget>[
                                      Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Text("MY NAME", style: TextStyle(fontSize: 16, color: Colors.grey[100], fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                                        ],
                                      ),
                                      ...
                                      Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Text("789", style: TextStyle(fontSize: 16, color: Colors.grey[100], fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                                        ],
                                      ),
                            ...
                            Container(
                              child: Text("Card Settings", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 18, color: Colors.black),),
                              padding: EdgeInsets.symmetric(horizontal: 32),
                            ),
